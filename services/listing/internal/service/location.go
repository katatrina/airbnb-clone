...
func (s *ListingService) ListDistrictsByProvince(ctx context.Context, provinceCode int32) ([]model.District, error) {
...
func (s *ListingService) ListWardsByDistrict(ctx context.Context, districtCode int32) ([]model.Ward, error) {
